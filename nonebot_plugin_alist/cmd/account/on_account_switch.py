...
from ...message import account_list_msg, account_info_msg
...
async def _(event: Event, state: T_State):
    ...
    alist_accounts = [alist_account for alist_account in alist_accounts if alist_account.token]
